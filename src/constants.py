...
_USER_INFO_FILE_DESCRIPTION_INDEX = 5
_USER_INFO_FILE_FRIENDS_COUNT_INDEX = 6
_USER_INFO_FILE_CREATED_AT_INDEX = 7
_USER_INFO_FILE_LISTED_COUNT_INDEX = 8
_USER_INFO_FILE_VERIFIED_INDEX = 9
